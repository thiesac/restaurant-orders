...
# Req 2
def test_dish():
    """Garanta que o nome passado no construtor
    ...
    """Garanta que o método add_ingredient_dependency
    ...
    """Garanta que o método get_restrictions tenha o comportamento esperado"""
